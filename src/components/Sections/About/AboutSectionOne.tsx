...
const AboutSectionOne = () => {
  const List = ({ text }: { text: string }) => (
    <div className="mb-2 flex items-center sm:mb-5 group">
  ...
  return (
    <section className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-white to-gray-50/50 dark:from-gray-dark dark:to-gray-800/50 py-8 md:py-16 lg:py-28 relative overflow-hidden">
      ...
      <div className="container w-full px-4 md:px-6 lg:px-8 relative z-10">
        <div className="border-b border-body-color/[.15] pb-8 dark:border-white/[.15] md:pb-16 lg:pb-20">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative mx-auto aspect-25/24 max-w-[500px] text-center lg:ml-auto lg:mr-0">
                <Image
